      ...
      <Grid container>
        ...
        >
          ...
          >
            ...
            <Typography variant="body2">
              <strong>Account Name:</strong> Sri Sanyasikatte Parashurama Temple
            </Typography>
            <Typography variant="body2">
              <strong>Account Number:</strong> 123456789012
            </Typography>
            <Typography variant="body2">
              <strong>IFSC Code:</strong> CNRB0001234
            </Typography>
          </Box>
        </Grid>
              ...
              {whyItems.map((txt, i) => (
                <ListItem key={i} sx={{ py: 0.25 }}>
                  <ListItemIcon sx={{ minWidth: 28 }}>
                    <CheckCircleOutlineIcon sx={{ fontSize: 18, color: 'gold.main' }} />
                  </ListItemIcon>
                  <ListItemText
